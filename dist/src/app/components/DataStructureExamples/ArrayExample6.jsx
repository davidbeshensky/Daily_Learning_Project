...
const ReinventingTheWheel = () => {
    ...
    const [numberArray] = useState([1, 2, 3, 4, 5, 6, 7, 8, 9]);
    const [booleanArray] = useState([
        false,
        false,
        false,
        false,
    ...
    const [unsortedArray] = useState([1, 3, 7, 4, 2]);
    ...
    //   BINARY SEARCH
    //   is it ordered?
    const binarySearch = (numberArray, targetNumber) => {
    ...
    const crystalBallSearch = (boolArray) => {
    ...
    return (<div>
      ...
      <div className="border-2 p-2 m-2">
        ...
        <button className="border-2 p-2 hover:bg-slate-800 transition-transform transform active:scale-95 active:bg-slate-500 focus:outline-none" onClick={handleSort}>
          Sort Array
        </button>
        <p>
