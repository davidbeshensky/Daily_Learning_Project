...
const ContainsDuplicate = () => {
    ...
    const [duplicateBool, setDuplicateBool] = useState(false);
    const handleSubmit = () => {
    ...
    return (<div className="p-4">
      ...
      <div className="flex gap-2 mb-4">
        <input className="text-black p-2 border rounded" type="text" value={inputValue} onChange={(e) => setInputValue(e.target.value)} placeholder="Enter numbers 0-9"/>
        <button onClick={handleSubmit} className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition">
          submit button
        </button>
      </div>
      {duplicateBool !== null && (<p className="text-lg">
