    ...
    return (<div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
          ...
          <div>
            <label>
              ...
              <input type="text" className="text-black w-full" value={data.numbers.join(', ')} onChange={(e) => setData({
            ...data,
          ...
          <div>
            <label>
              ...
              <input type="text" className="text-black w-full" value={data.words.join(', ')} onChange={(e) => setData({
            ...data,
