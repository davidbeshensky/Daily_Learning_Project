...
const ReactDocsExamples = () => {
    ...
    return (<div>
      <input type="text" value={firstName} onChange={handleFirstNameChange} placeholder="first name" className="p-2 m-2 text-black"/>
      <input type="text" value={lastName} onChange={handleLastNameChange} placeholder="last name" className="p-2 m-2 text-black"/>
